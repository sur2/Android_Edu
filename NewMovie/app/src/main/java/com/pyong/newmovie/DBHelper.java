...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(
                "create table movies " +
                        "(id integer primary key,name text, director text, year text, genre text, rating text)"
        );
    }
    ...
    public boolean insertMovie(String name, String director, String year, String genre, String rating) {
    ...
    public boolean updateMovie(Integer id, String name, String director, String year, String genre, String rating) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("name", name);
        contentValues.put("director", director);
